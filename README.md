...
| :---: | :---: | --- | --- | --- |
| 9 сентября | Лекция  01 | Архитектура GPU | [Ноутбук](./Seminars/01-gpu-and-cuda/lecture.pdf) | [Умножение векторов и матриц с использованием CUDA](./Tasks/task1/task_01.ipynb) |
