...
* Аудитория: 706
* Записи занятий выкладываются на [канале кафедры ММП](https://www.youtube.com/playlist?list=PLVF5PzSHILHSbDQGOvyXdKN_b6FrmDLbJ)
...
| 14 октября | Лекция  06 | Работа с большими моделями на одной GPU | [Презентация](./Seminars/06-large-models/lecture.pdf) | Работа с большими моделями на одной GPU |
